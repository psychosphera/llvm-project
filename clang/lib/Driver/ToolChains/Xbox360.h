//===--- Xbox360.h - Xbox360 ToolChain Implementations ----------*- C++ -*-===//
//
...
public:
  Linker(const ToolChain &TC) : Tool("Xbox360::Linker", "lld-link", TC) {}
...
#endif // LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_XBOX360_H
